...
include 'db_conn.php';
// $app_id=$_GET['app_id'];
$sql = "SELECT * FROM appointment_details WHERE doctors ='Dr.Varun Upadhyay' ORDER BY id DESC LIMIT 1";
								...
								<div class="widget-profile pro-widget-content">
									<div class="profile-info-widget">
										<a href="#" class="booking-doc-img">
											<img src="img/doc4.jpg" alt="User Image">
										</a>
										<div class="profile-det-info">
											<h3>Dr. Varun Upadhyay</h3>
											
											<div class="patient-details">
												<h5 class="mb-0">Neurologist</h5>
											</div>
										</div>
									</div>
								</div>
															...
															<table class="table table-hover table-center mb-0">
																...
																<tbody>
																	<tr>
																		...
																		<td>19 Dec 2022<span class="d-block text-info"></span></td>
																		<td>Test</td>
