...
include 'db_conn.php';
// $app_id=$_GET['app_id'];
$sql = "SELECT * FROM appointment_details WHERE doctors ='Dr.Rekha Singhal' ORDER BY id DESC LIMIT 1";
								...
								<div class="widget-profile pro-widget-content">
									<div class="profile-info-widget">
										<a href="#" class="booking-doc-img">
											<img src="derma.jpeg" alt="User Image">
										</a>
										<div class="profile-det-info">
											<h3>Dr. Rekha Singhal</h3>
															...
															<table class="table table-hover table-center mb-0">
																...
																<tbody>
																	<tr>
																		...
																		<td>16 Nov 2022<span class="d-block text-info"></span></td>
																		<td>Hair fall</td>
                                                                    ...
                                                                    <tr>
																		...
																		<td>7 Dec 2022<span class="d-block text-info"></span></td>
																		<td>Skin allergy</td>
