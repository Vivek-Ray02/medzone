...
include 'db_conn.php';
// $app_id=$_GET['app_id'];
$sql = "SELECT * FROM appointment_details WHERE first_name = 'Shivesh' ORDER BY id DESC LIMIT 1";
                    ...
                    <div class="widget-profile pro-widget-content">
                        <div class="profile-info-widget">
                            <a href="#" class="booking-doc-img">
                                <img src="img/pat/shivesh.png" alt="User Image">
                            </a>
                            <div class="profile-det-info">
                                <h3>Shivesh Bhat</h3>
                                <div class="patient-details">
                                    <h5><i class="fas fa-birthday-cake"></i> 25 Mar 1990, 33 years</h5>
                                            ...
                                            <table class="table table-hover table-center mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>5 May 2023 <span class="d-block text-info">4:00 PM</span></td>
                                                        <td>5 May 2023</td>
                                                        <td>Rs. 1000</td>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                    <img class="avatar-img rounded-circle" src="doc12.jpg" alt="User Image">
                                                                </a>
