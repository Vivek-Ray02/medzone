...
include 'db_conn.php';
// $app_id=$_GET['app_id'];
$sql = "SELECT * FROM appointment_details WHERE doctors ='Dr.Priya Kapoor' ORDER BY id DESC LIMIT 1";
								...
								<div class="widget-profile pro-widget-content">
									<div class="profile-info-widget">
										<a href="#" class="booking-doc-img">
											<img src="img/doc6.jpg" alt="User Image">
										</a>
															...
															<table class="table table-hover table-center mb-0">
																...
																<tr>
                                                                    ...
                                                                    <tr>
																		...
																		<td>7 May 2023<span class="d-block text-info">10:00 AM</span></td>
																		<td>General</td>
															...
															<table class="table table-hover table-center mb-0">
																...
																<tbody>
																	<tr>
																		...
																		<td>26 Sept 2022<span class="d-block text-info"></span></td>
																		<td>Root Canal</td>
                                                                    ...
                                                                    <tr>
																		...
																		<td>22 Sept 2022<span class="d-block text-info"></span></td>
																		<td>Root Canal</td>
