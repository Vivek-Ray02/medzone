...
include 'db_conn.php';
// $app_id=$_GET['app_id'];
$sql = "SELECT * FROM appointment_details WHERE first_name = 'Kanishka' ORDER BY id DESC LIMIT 1";
                    ...
                    <div class="widget-profile pro-widget-content">
                        <div class="profile-info-widget">
                            <a href="#" class="booking-doc-img">
                                <img src="img/pat3.jpg" alt="User Image">
                            </a>
                            <div class="profile-det-info">
                                <h3>Kanishka Raikwar</h3>
                                <div class="patient-details">
                                    <h5><i class="fas fa-birthday-cake"></i> 8 April 1999, 24 years</h5>
