...
include 'db_conn.php';
// $app_id=$_GET['app_id'];
$sql = "SELECT * FROM appointment_details WHERE doctors ='Dr.Swati Sharma' ORDER BY id DESC LIMIT 1";
								...
								<div class="widget-profile pro-widget-content">
									<div class="profile-info-widget">
										<a href="#" class="booking-doc-img">
											<img src="img/doc2.jpg" alt="User Image">
										</a>
																...
																<tr>
																		<td>
																			<h2 class="table-avatar">
																				<!-- <a href="Dev.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="dev.jpeg" alt="User Image"></a> -->
																	...
																	<tr>
																		<td>
																			<h2 class="table-avatar">
																				<a href="Dev.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="dev.jpeg" alt="User Image"></a>
																				<a href="Dev.html">Dev Savla <span>#P106</span></a>
																			</h2>
																		</td>
																		<td>18 Apr 2023<span class="d-block text-info">1:00 PM</span></td>
																		<td>General</td>
																...
																<tbody>
																	<tr>
																		<td>
																			<h2 class="table-avatar">
																				<a href="Dev.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="dev.jpeg" alt="User Image"></a>
																				<a href="Dev.html">Dev Savla<span>#P110</span></a>
																			</h2>
																		</td>
																		<td>17 Feb 2023<span class="d-block text-info"></span></td>
