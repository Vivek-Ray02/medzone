...
include 'db_conn.php';
// $app_id=$_GET['app_id'];
$sql = "SELECT * FROM appointment_details WHERE doctors ='Dr.Neha Singh' ORDER BY id DESC LIMIT 1";
								...
								<div class="widget-profile pro-widget-content">
									<div class="profile-info-widget">
										<a href="#" class="booking-doc-img">
											<img src="img/2.jpg" alt="User Image">
										</a>
										<div class="profile-det-info">
											<h3>Dr. Neha Singh</h3>
											
											<div class="patient-details">
												<h5 class="mb-0">Dentist</h5>
											</div>
										</div>
									</div>
								</div>
															...
															<table class="table table-hover table-center mb-0">
																...
																<tr>
																	...
																	<tr>
																		<td>
																			<h2 class="table-avatar">
																				<a href="pranay.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="shivesh.png" alt="User Image"></a>
																				<a href="pranay.html">Shivesh Bhat <span>#P105</span></a>
																			</h2>
																		</td>
																		<td>16 Apr 2023<span class="d-block text-info">10:AM</span></td>
																		<td>General</td>
															...
															<table class="table table-hover table-center mb-0">
																...
																<tbody>
                                                                    ...
                                                                    <tr>
																		<td>
																			<h2 class="table-avatar">
																				<a href="pat_dashboard.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="mrudula.jpeg" alt="User Image"></a>
																				<a href="pat_dashboard.html">Mrudula Sawant<span>#P101</span></a>
																			</h2>
																		</td>
																		<td>22 Feb 2023<span class="d-block text-info"></span></td>
                                                                    ...
                                                                    <tr>
																		<td>
																			<h2 class="table-avatar">
																				<a href="pat_dash2.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="sania.jpeg" alt="User Image"></a>
																				<a href="pat_dash2.html">Aditi Sambrekar<span>#P102</span></a>
																			</h2>
																		</td>
																		<td>24 Dec 2022<span class="d-block text-info"></span></td>
																		<td>Teeth cleaning</td>
																		
																		<td class="text-center">Rs. 1500</td>
																		<td class="text-right">
                                                                    ...
                                                                    <tr>
																		<td>
																			<h2 class="table-avatar">
																				<a href="kanishka.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="img/pat3.jpg" alt="User Image"></a>
																				<a href="kanishka.html">Kanishka Raikwar<span>#P103</span></a>
																			</h2>
																		</td>
																		<td>11 Feb 2023<span class="d-block text-info"></span></td>
																		<td>Root Canal</td>
																		
																		<td class="text-center">Rs. 4000</td>
																		<td class="text-right">
                                                                    ...
                                                                    <tr>
																		...
																		<td>23 Dec 2022<span class="d-block text-info"></span></td>
																		<td>Teeth Cleaning</td>
                                                                    ...
                                                                    <tr>
																		<td>
																			<h2 class="table-avatar">
																				<a href="dhruvi.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="dhruvi.jpeg" alt="User Image"></a>
																				<a href="dhruvi.html">Dhruvi Shah<span>#P109</span></a>
																			</h2>
																		</td>
																		<td>16 Feb 2023<span class="d-block text-info"></span></td>
																		<td>Root Canal</td>
