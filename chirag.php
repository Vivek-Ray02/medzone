...
include 'db_conn.php';
// $app_id=$_GET['app_id'];
$sql = "SELECT * FROM appointment_details WHERE first_name = 'Chirag' ORDER BY id DESC LIMIT 1";
                    ...
                    <div class="widget-profile pro-widget-content">
                        <div class="profile-info-widget">
                            <a href="#" class="booking-doc-img">
                                <img src="img/pat/chirag.jpeg" alt="User Image">
                            </a>
                            <div class="profile-det-info">
                                <h3>Chirag Sharma</h3>
                                <div class="patient-details">
                                    <h5><i class="fas fa-birthday-cake"></i>12 Jan 1993, 30 years</h5>
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                    <img class="avatar-img rounded-circle" src="img/doc11.jpg" alt="User Image">
                                                                </a>
