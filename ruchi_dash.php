...
include 'db_conn.php';
// $app_id=$_GET['app_id'];
$sql = "SELECT * FROM appointment_details WHERE doctors ='Dr.Ruchi Verma' ORDER BY id DESC LIMIT 1";
								...
								<div class="widget-profile pro-widget-content">
									<div class="profile-info-widget">
										<a href="#" class="booking-doc-img">
											<img src="img/doc14.jpg" alt="User Image">
										</a>
										<div class="profile-det-info">
											<h3>Dr. Ruchi Verma</h3>
											
											<div class="patient-details">
												<h5 class="mb-0">Orthopedic</h5>
											</div>
										</div>
									</div>
								</div>
															...
															<table class="table table-hover table-center mb-0">
																...
																<tbody>
                                                                    <tr>
																		<td>
																			<h2 class="table-avatar">
																			 <!-- <a href="patient-profile.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="img/pat/uditi.jpeg" alt="User Image"></a>  -->
																				<a href="chirag.html">
																			</h2>
																		</td>
																		<td></td>
																	...
																	<tr>																		<td>
																		...
																		<td>23 Nov 2022<span class="d-block text-info"></span></td>
																		<td>Leg Pain</td>
                                                                    ...
                                                                    <tr>
																		...
																		<td>23 Feb 2023<span class="d-block text-info"></span></td>
																		<td>Hand Fracture</td>
                                                                    ...
                                                                    <tr>
																		...
																		<td>14 Nov 2022<span class="d-block text-info"></span></td>
																		<td>Arms Pain</td>
                                                                    ...
                                                                    <tr>
																		<td>
																			<h2 class="table-avatar">
																				<a href="uditi.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="uditi.jpeg" alt="User Image"></a>
																				<a href="uditi.html">Uditi Sinha<span>#P106</span></a>
																			</h2>
																		</td>
