...
include 'db_conn.php';
// $app_id=$_GET['app_id'];
$sql = "SELECT * FROM appointment_details WHERE doctors ='Dr.Meera Reddy' ORDER BY id DESC LIMIT 1";
								...
								<div class="widget-profile pro-widget-content">
									<div class="profile-info-widget">
										<a href="#" class="booking-doc-img">
											<img src="img/doc8.jpg" alt="User Image">
										</a>
															...
															<table class="table table-hover table-center mb-0">
																...
																<tbody>
                                                                    <tr>
																		<td>
																			<h2 class="table-avatar">
																				...
																				<a href="kanishka.html"><?php echo $data['first_name']; ?>&nbsp<?php echo $data['last_name']; ?></a>
																			</h2>
																		</td>
                                                                    ...
                                                                    <tr>
																		...
																		<td>22 April 2023<span class="d-block text-info">6:00 PM</span></td>
																		<td>General</td>
                                                                    ...
                                                                    <tr>
																		...
																		<td>21 April 2023<span class="d-block text-info">6:00 PM</span></td>
																		<td>General</td>
															...
															<table class="table table-hover table-center mb-0">
																...
																<tbody>
																	<tr>
																		...
																		<td>9 Dec 2022<span class="d-block text-info"></span></td>
																		<td>Fever</td>
