...
include 'db_conn.php';
// $app_id=$_GET['app_id'];
$sql = "SELECT * FROM appointment_details WHERE doctors ='Dr.Ashutosh Patel' ORDER BY id DESC LIMIT 1";
								...
								<div class="widget-profile pro-widget-content">
									<div class="profile-info-widget">
										<a href="#" class="booking-doc-img">
											<img src="img/doc10.jpg" alt="User Image">
										</a>
										<div class="profile-det-info">
											<h3>Dr. Ashutosh Patel</h3>
											
											<div class="patient-details">
												<h5 class="mb-0">Orthopedician</h5>
											</div>
										</div>
									</div>
								</div>
																...
																<tr>
																		<td>
																			<h2 class="table-avatar">
																				<!-- <a href="vatsal.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="dev.jpeg" alt="User Image"></a> -->
																				<a href="uditi.html"><?php echo $data['first_name']; ?>&nbsp<?php echo $data['last_name']; ?><span>#P106</span></a>
																			</h2>
																		</td>
																		<td><?php echo $data['appointment_date']; ?><span class="d-block text-info"><?php echo $data['appointment_time']; ?></span></td>
																		<td>General</td>
																		
																		<td class="text-center">Rs. 1200</td>
																		<td class="text-right">
                                                                    ...
                                                                    <tr>
																		<td>
																			<h2 class="table-avatar">
																				<a href="vatsal.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="pat4.jpeg" alt="User Image"></a>
																				<a href="vatsal.html">Vatsal Sanchala<span>#P108</span></a>
																			</h2>
																		</td>
																		<td>7 May 2023<span class="d-block text-info">7:00 PM</span></td>
																		<td>General</td>
															...
															<table class="table table-hover table-center mb-0">
																...
																<tbody>
                                                                    ...
                                                                    <tr>
																		...
																		<td>26 Nov 2022<span class="d-block text-info"></span></td>
																		<td>Arms Pain</td>
