...
include 'db_conn.php';
// $app_id=$_GET['app_id'];
$sql = "SELECT * FROM appointment_details WHERE first_name = 'Dhruvi' ORDER BY id DESC LIMIT 1";
                    ...
                    <div class="widget-profile pro-widget-content">
                        <div class="profile-info-widget">
                            <a href="#" class="booking-doc-img">
                                <img src="img/pat/dhruvi.jpeg" alt="User Image">
                            </a>
                            <div class="profile-det-info">
                                <h3>Dhruvi Shah</h3>
                                <div class="patient-details">
                                    <h5><i class="fas fa-birthday-cake"></i> 8 April 1990, 33 years</h5>
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                    <img class="avatar-img rounded-circle" src="img/doc10.jpg" alt="User Image">
                                                                </a>
                                                                <a href="doctor-profile.html">Dr. Abhishek Singh <span>Gynecology</span></a>
                                                            </h2>
                                                        </td>
                                                        <td>7 May 2023 <span class="d-block text-info">11:00 AM</span></td>
                                                        <td>6 May 2023</td>
                                                        <td>Rs. 2000</td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                ...
                                                                <a href="doctor-profile.html">Dr. Sunita Singh <span>Cardiology</span></a>
                                                            </h2>
                                                        </td>
                                                        <td class="text-right">
                                                            <div class="table-action">
