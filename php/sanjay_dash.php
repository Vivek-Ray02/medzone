...
include 'db_conn.php';
// $app_id=$_GET['app_id'];
$sql = "SELECT * FROM appointment_details WHERE doctors ='Dr.Sanjay Patel' ORDER BY id DESC LIMIT 1";
								...
								<div class="widget-profile pro-widget-content">
									<div class="profile-info-widget">
										<a href="#" class="booking-doc-img">
											<img src="img/doc16.png" alt="User Image">
										</a>
										<div class="profile-det-info">
											<h3>Dr. Sanjay Patel</h3>
											
											<div class="patient-details">
												<h5 class="mb-0">Physcian</h5>
											</div>
										</div>
									</div>
								</div>
															...
															<table class="table table-hover table-center mb-0">
																...
																<tbody>
																	<tr>
																		<td>
																			<h2 class="table-avatar">
																				<a href="chirag.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="chirag.jpeg" alt="User Image"></a>
																				<a href="chirag.html">Chirag Sharma<span>#P104</span></a>
																			</h2>
																		</td>
                                                                    ...
                                                                    <tr>
																		<td>
																			<h2 class="table-avatar">
																				<a href="chirag.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="pat4.jpeg" alt="User Image"></a>
																				<a href="chirag.html">Vatsal Sanchala<span>#P108</span></a>
																			</h2>
																		</td>
																		<td>13 Dec 2022<span class="d-block text-info"></span></td>
																		<td>Cold</td>
                                                                    ...
                                                                    <tr>
																		...
																		<td>11 Dec 2022<span class="d-block text-info"></span></td>
																		<td>Cold</td>
