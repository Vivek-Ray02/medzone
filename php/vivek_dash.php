...
include 'db_conn.php';
// $app_id=$_GET['app_id'];
$sql = "SELECT * FROM appointment_details WHERE doctors ='Dr.Vivek Sharma' ORDER BY id DESC LIMIT 1";
								...
								<div class="widget-profile pro-widget-content">
									<div class="profile-info-widget">
										<a href="#" class="booking-doc-img">
											<img src="img/doc9.jpg" alt="User Image">
										</a>
															...
															<table class="table table-hover table-center mb-0">
																...
																<tbody>
                                                                    ...
                                                                    <tr>
																		...
																		<td>13 Nov 2022<span class="d-block text-info"></span></td>
