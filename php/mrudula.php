...
include 'db_conn.php';
// $app_id=$_GET['app_id'];
$sql = "SELECT * FROM appointment_details WHERE first_name ='Mrudula' ORDER BY id DESC LIMIT 1";
                    ...
                    <div class="widget-profile pro-widget-content">
                        <div class="profile-info-widget">
                            <a href="#" class="booking-doc-img">
                                <img src="img/pat/mrudula.jpeg" alt="User Image">
                            </a>
                            <div class="profile-det-info">
                                <h3>Mrudula Sawant</h3>
                                <div class="patient-details">
                                    <h5><i class="fas fa-birthday-cake"></i> 24 Jul 2003, 19 years</h5>
                                            ...
                                            <table class="table table-hover table-center mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>4 May 2023 <span class="d-block text-info">4:00 PM</span></td>
                                                        <td>4 May 2023</td>
                                                        <td>Rs. 1000</td>
                                                        <td><span class="badge badge-pill bg-success-light">Confirm</span></td>
                                                        <td class="text-right">
                                                ...
                                                <tbody>
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                    <img class="avatar-img rounded-circle" src="img/2.jpg" alt="User Image">
                                                                </a>
                                                                <a href="neha_doc_prof.html">Dr. Neha Singh <span>Dental</span></a>
                                                            </h2>
                                                        </td>
                                                        <td class="text-right">
                                                            <div class="table-action">
                                                                ...
                                                                <a href="dental.pdf" class="btn btn-sm bg-info-light">
                                                                    <i class="far fa-eye"></i> View
                                                                </a>
                                                            </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                    <img class="avatar-img rounded-circle" src="img/doc12.jpg" alt="User Image">
                                                                </a>
                                                                <a href="doctor-profile.html">Dr. Avinash Patel <span>Cardiology</span></a>
                                                            </h2>
                                                        </td>
                                                        <td class="text-right">
                                                            <div class="table-action">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                    <img class="avatar-img rounded-circle" src="img/doc14.jpg" alt="User Image">
                                                                </a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                    <img class="avatar-img rounded-circle" src="img/doc3.jpg" alt="User Image">
                                                                </a>
                                                                <a href="doctor-profile.html">Dr. Rajesh Gupta<span>Physician</span></a>
                                                            </h2>
                                                        </td>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover table-center mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><a href="javascript:void(0);">#MR-105</a></td>
                                                        <td>15 Nov 2022</td>
                                                        <td>Fever</td>
                                                    ...
                                                    <tr>
                                                        <td><a href="javascript:void(0);">#MR-106</a></td>
                                                        <td>11 Oct 2023</td>
                                                        <td>Cold</td>
                                                        <td><a href="#">dental-test.pdf</a></td>
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                ...
                                                                <a href="doctor-profile.html">Dr. Rajesh Gupta <span>Dental</span></a>
                                                            </h2>
                                                        </td>
                                                        <td class="text-right">
                                                            <div class="table-action">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover table-center mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="invoice-view.html">105</a>
                                                        </td>
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <a href="invoice-view.html">106</a>
                                                        </td>
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
