...
include 'db_conn.php';
// $app_id=$_GET['app_id'];
$sql = "SELECT * FROM appointment_details WHERE doctors ='Dr.Avinash Patel' ORDER BY id DESC LIMIT 1";
								...
								<div class="widget-profile pro-widget-content">
									<div class="profile-info-widget">
										<a href="#" class="booking-doc-img">
											<img src="img/doc12.jpg" alt="User Image">
										</a>
										<div class="profile-det-info">
											<h3>Dr. Avinash Patel</h3>
											
											<div class="patient-details">
												<h5 class="mb-0">Cardiologist</h5>
											</div>
										</div>
									</div>
								</div>
															...
															<table class="table table-hover table-center mb-0">
																...
																<tbody>
																	...
																	<tr>
																		...
																		<td>28 Feb 2023<span class="d-block text-info"></span></td>
