...
include 'db_conn.php';
// $app_id=$_GET['app_id'];
$sql = "SELECT * FROM appointment_details WHERE doctors ='Dr.Sunita Singh' ORDER BY id DESC LIMIT 1";
								...
								<div class="widget-profile pro-widget-content">
									<div class="profile-info-widget">
										<a href="#" class="booking-doc-img">
											<img src="img/doc11.jpg" alt="User Image">
										</a>
															...
															<table class="table table-hover table-center mb-0">
																...
																<tbody>
                                                                    ...
                                                                    <tr>
																		...
																		<td>22 Mar 2023<span class="d-block text-info"></span></td>
																		<td>Chest Pain</td>
                                                                    ...
                                                                    <tr>
																		...
																		<td>11 Mar 2023<span class="d-block text-info"></span></td>
																		<td>Chest Pain</td>
