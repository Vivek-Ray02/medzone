...
include 'db_conn.php';
// $app_id=$_GET['app_id'];
$sql = "SELECT * FROM appointment_details WHERE first_name = 'Vatsal' ORDER BY id DESC LIMIT 1";
                    ...
                    <div class="widget-profile pro-widget-content">
                        <div class="profile-info-widget">
                            <a href="#" class="booking-doc-img">
                                <img src="pat4.jpeg" alt="User Image">
                            </a>
                            <div class="profile-det-info">
                                <h3>Vatsal Sanchala</h3>
                                <div class="patient-details">
                                    <h5><i class="fas fa-birthday-cake"></i>12 Jan 1997, 26 years</h5>
                                    <h5 class="mb-0"><i class="fas fa-map-Aprker-alt"></i> Mumbai, Maharashtra</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <div class="table-action">
                                                                <a href="javascript:void(0);" class="btn btn-sm bg-priApry-light">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                ...
                                                                <a href="doctor-profile.html">Dr. Anil Kumar <span>Physician</span></a>
                                                            </h2>
                                                        </td>
                                                        <td>14th May 2023 <span class="d-block text-info">4:00 PM</span></td>
                                                        <td>3 May 2023</td>
                                                        <td>Rs. 1000</td>
                                                ...
                                                <tbody> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                    <img class="avatar-img rounded-circle" src="doc11.jpg" alt="User Image">
                                                                </a>
                                                                <a href="doctor-profile.html">Dr. Sunita  Singh <span>Orthopedic</span></a>
                                                            </h2>
                                                        </td>
                                                        <td class="text-right">
                                                            <div class="table-action">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                    <img class="avatar-img rounded-circle" src="doc9.jpg" alt="User Image">
                                                                </a>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                    <img class="avatar-img rounded-circle" src="doc4.jpg" alt="User Image">
                                                                </a>
                                                                <a href="doctor-profile.html">Dr. Vivek Sharma <span>Veterinary</span></a>
                                                            </h2>
                                                        </td>
                                                        <td class="text-right">
                                                            <div class="table-action">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                    <img class="avatar-img rounded-circle" src="doc6.jpg" alt="User Image">
                                                                </a>
                                                                <a href="doctor-profile.html">Dr. Priya Kapoor <span>Dental</span></a>
                                                            </h2>
                                                        </td>
                                                        <td class="text-right">
                                                            <div class="table-action">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                ...
                                                                <a href="doctor-profile.html">Dr. Priya Kapoor <span>Physician</span></a>
                                                            </h2>
                                                        </td>
                                                        <td>Rs. 2500</td>
                                                        <td>22 Sept 2022</td>
