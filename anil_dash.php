...
include 'db_conn.php';
// $app_id=$_GET['app_id'];
$sql = "SELECT * FROM appointment_details WHERE doctors ='Dr.Anil Kumar' ORDER BY id DESC LIMIT 1";
								...
								<div class="widget-profile pro-widget-content">
									<div class="profile-info-widget">
										<a href="#" class="booking-doc-img">
											<img src="doc7.jpg" alt="User Image">
										</a>
										<div class="profile-det-info">
											<h3>Dr. Anil Kumar</h3>
											
											<div class="patient-details">
												<h5 class="mb-0">Veterinary</h5>
											</div>
										</div>
									</div>
								</div>
															...
															<table class="table table-hover table-center mb-0">
																...
																<tr>
                                                                    ...
                                                                    <tr>
																		...
																		<td>24 April 2023<span class="d-block text-info">11:00 AM</span></td>
																		<td>General</td>
																	...
																	<tr>
																		...
																		<td>5 May 2023<span class="d-block text-info">11:00 AM</span></td>
																		<td>General</td>
															...
															<table class="table table-hover table-center mb-0">
																...
																<tbody>
																	<tr>
																		<td>
																			<h2 class="table-avatar">
																				<a href="pat_dashboard.html" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="uditi.jpeg" alt="User Image"></a>
																				<a href="pat_dashboard.html">Uditi Sinha<span>#P106</span></a>
																			</h2>
																		</td>
																		<td>17 Jan 2023<span class="d-block text-info"></span></td>
