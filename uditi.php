<?php
include 'db_conn.php';
$sql = "SELECT * FROM appointment_details WHERE first_name = 'Uditi' ORDER BY id DESC LIMIT 1";
                    ...
                    <div class="widget-profile pro-widget-content">
                        <div class="profile-info-widget">
                            <a href="#" class="booking-doc-img">
                                <img src="img/pat/uditi.jpeg"alt="User Image">
                            </a>
                            <div class="profile-det-info">
                                <h3>Uditi Sinha</h3>
                                <div class="patient-details">
                                    <h5><i class="fas fa-birthday-cake"></i>11 Aug 2000, 23 years</h5>
                                                        ...
                                                        <td>
                                                            <h2 class="table-avatar">
                                                                <a href="doctor-profile.html" class="avatar avatar-sm mr-2">
                                                                    <img class="avatar-img rounded-circle" src="doc1.jpeg" alt="User Image">
                                                                </a>
                                                                <a href="doctor-profile.html">Dr. Anil Kumar <span>Veterinary</span></a>
                                                            </h2>
                                                        </td>
                                                        <td>4 May 2023 <span class="d-block text-info">2:00 PM</span></td>
                                                        <td>4 May 2023</td>
                                                        <td>Rs. 1000</td>
                                                        <td><span class="badge badge-pill bg-success-light">Confirm</span></td>
                                                        <td class="text-right">
